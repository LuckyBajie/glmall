package com.glmall.thirdparty.utils;
...
public class MinioUtil {
    ...
    public void putObject(
            String bucketName, MultipartFile multipartFile, String pathName, String filename, String fileType) {
        InputStream inputStream = new ByteArrayInputStream(multipartFile.getBytes());

        minioClient.putObject(
                PutObjectArgs.builder().bucket(bucketName).object(pathName + "/" + filename).stream(
